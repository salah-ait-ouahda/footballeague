    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.players.update", [$player->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $player->name) }}" required>
                            @if($errors->has('name'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('name') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="prenom" id="prenom" value="{{ old('prenom', $player->prenom) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cine" id="cine" value="{{ old('cine', $player->cine) }}">
                            @if($errors->has('cine'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cine') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="birthday_date" id="birthday_date" value="{{ old('birthday_date', $player->birthday_date) }}" required>
...
<script>
    ...
    url: '{{ route('frontend.players.storeMedia') }}',
    maxFilesize: 2, // MB
