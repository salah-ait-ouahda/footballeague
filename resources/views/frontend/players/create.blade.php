    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.players.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cine" id="cine" value="{{ old('cine', '') }}">
                            @if($errors->has('cine'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cine') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="birthday_date" id="birthday_date" value="{{ old('birthday_date') }}" required>
