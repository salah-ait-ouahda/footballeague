        ...
        <div class="col-md-12">
            @can('player_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.players.create') }}">
                            ...
                            <tbody>
                                @foreach($players as $key => $player)
                                    <tr data-entry-id="{{ $player->id }}">
                                        ...
                                        <td>
                                            @can('player_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.players.show', $player->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('player_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.players.edit', $player->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('player_delete')
                                                <form action="{{ route('frontend.players.destroy', $player->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('player_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.players.massDestroy') }}",
