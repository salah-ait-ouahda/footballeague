...
class BordereauController extends Controller
{
    public function index()
    {
        ...
        return view('admin.bordereaus.index', compact('bordereaus'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.bordereaus.create', compact('teams'));
    }
    ...
    public function store(StoreBordereauRequest $request)
    {
        ...
        return redirect()->route('admin.bordereaus.index');
    }
    ...
    public function edit(Bordereau $bordereau)
    {
        ...
        return view('admin.bordereaus.edit', compact('teams', 'bordereau'));
    }
    ...
    public function show(Bordereau $bordereau)
    {
        ...
        return view('admin.bordereaus.show', compact('bordereau'));
    }
